...
public class TwitterClient extends OAuthBaseClient {
	...
	public void favorite(String tweet, JsonHttpResponseHandler handler) {
	...
	public void unfavorite(String tweet, JsonHttpResponseHandler handler) {
	...
	public void replyToTweet(String idOfTweetToReplyTo, String tweet, JsonHttpResponseHandler handler) {
		String apiUrl = getApiUrl("statuses/update.json");
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("status", tweet); // body of tweet
